<html>
<head>
    <title>Update Penugasan Bike Sharing</title>
...
<tr> 
	<td> <b>Petugas</b> </td>
	<td> : </td>
    <td> <input type="text" size="60" maxlength="60" name="isipetugas"></td>
    </td>
</tr>
...
<tr> 
	<td> <b>Stasiun<b> </td>
	<td> : </td>
    <td> <input type="text" size="60" maxlength="60" name="isistasiun"></td>
    </select>
</tr>
